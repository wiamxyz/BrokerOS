...
export function Workspace({view}:{view:string}){
 ...
 const[collapsed,setCollapsed]=useState(false);const expandButton=useRef<HTMLButtonElement>(null);const collapseButton=useRef<HTMLButtonElement>(null);const sidebarFocus=useRef(false);const[actionTarget,setActionTarget]=useState<HTMLDivElement|null>(null);
